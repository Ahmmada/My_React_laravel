...
return [
        ...
        'custom' => [
        'attendance_date' => [
            'unique' => 'تم تسجيل حضور لهذه المجموعة في هذا التاريخ مسبقاً',
        ],
        'teachers.*.departure_time' => [
            'after' => 'وقت الانصراف يجب أن يكون بعد وقت الحضور',
        ],
    ],
    ...
    'digits_between' => 'يجب أن يكون حقل :attribute مكونًا من أرقام تتراوح بين :min و :max.',
    'dimensions' => 'أبعاد الصورة لحقل :attribute غير صالحة.',
    ...
    'password' => [
        ...
        'uncompromised' => 'لقد ظهر حقل :attribute هذا في تسرب بيانات. يرجى اختيار :attribute مختلف.',
    ],
    ...
    'unique' => 'قيمة حقل :attribute هذه مستخدمة بالفعل.',
